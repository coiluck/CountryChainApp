...
const westNorthAfrica = ['DZA', 'BEN', 'BFA', 'EGY', 'GMB', 'GHA', 'GIN', 'GNB', 'CIV', 'LBR', 'LBY', 'MLI', 'MRT', 'MAR', 'SEN', 'TGO', 'TUN', 'ESH'];
const centralAfrica = ['AGO', 'BDI', 'CMR', 'CAF', 'TCD', 'COD', 'COG', 'GNQ', 'GAB', 'NER', 'NGA', 'RWA', 'SLE', 'SSD', 'SDN', 'UGA'];
const eastSouthAfrica = ['BWA', 'DJI', 'ERI', 'SWZ', 'ETH', 'KEN', 'LSO', 'MDG', 'MWI', 'MOZ', 'NAM', 'SOM', 'ZAF', 'TZA', 'ZMB', 'ZWE'];
